  ...
  <div class="overlay" id="edit-overlay">
			<div class="edit-form-wrapper">
				<form action="action.php?action=edit" method="POST">
					...
					$id=$bus['id'];
					$data2->detailRute($id);
					foreach($data2->detailRute($id) as $bus2){
					?>
					<div class="group-input-wrapper">
						<div class="input-wrapper">
							<label for="Asal">Asal</label>
							<input type="text" id="asal" name="asal" value="<?=$bus2['asal'];?>" />
						</div>
						<div class="input-wrapper">
							<label for="tujuan">Tujuan</label>
							<input type="text" id="tujuan" name="tujuan" value="<?=$bus2['tujuan'];?>" />
						</div>
						<div class="input-wrapper">
						...
						<div class="input-wrapper">
							...
							<input type="text" id="harga" name="harga" value="<?=$bus2['harga'];?>" />
						</div>
						<?php } ?>
					</div>
					...
					<div class="group-input-wrapper">
						...
						<div class="input-wrapper">
							...
							<input
								...
								id="kelas-armada"
								name="kelas-armada"
								placeholder="Masukkan Kelas Bus"
							/>
						</div>
						<div class="input-wrapper">
							<label for="harga">Harga</label>
