...
<body>
  <main class="container">
      ...
      <div class="left-section">
        ...
        <div class="row-three">
          ...
          <div class="harga-tiket-wrapper">
            <p class="rp">Rp.</p>
            <p class="nominal"><?= number_format($harga, 2, ',', '.') ?></p>
          </div>
        </div>
      </div>
      <!-- akhir -->
    ...
    <div class="btn-wrapper">
      ...
      <div class="cetak-button">
        <a href="booking.php?kode_jadwal=<?= $kode_jadwal ?>&kode_bus=<?= $kode_bus ?>&no_pol=<?= $no_pol ?>&asal=<?= $asal ?>&tujuan=<?= $tujuan ?>&tanggal=<?= $tanggal ?>&choice=<?= $waktu ?>&harga=<?= $harga ?>&no_kursi=<?= $no_kursi ?>">Kembali</a>
      </div>
    </div>
  </main>
  <script>
