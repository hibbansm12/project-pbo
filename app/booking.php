...
if (isset($_REQUEST['submit'])) {
	...
	$sql = "INSERT INTO status_kursi (`id`, `kode_bus`, `kode_kursi`) VALUES ('','$kode_bus', '$no_kursi')";
...
<body>
	<form action="status_kursi.php" method="POST">
		<div class="hidden-input-wrapper" style="visibility: hidden;">
			<input type="hidden" name="kode_jadwal" value="<?= $kode_jadwal ?>">
			<input type="hidden" name="no_tiket" value="<?= $no_tiket ?>">
			<input type="hidden" name="kode_bus" value="<?= $kode_bus ?>">
			...
			<div class="right-section">
				...
				<div class="right-bottom-section">
					<div class="group-btn-wrapper">
						<button type="submit" name="submit" class="js-click-link" value="submit" id="btn-isi">Isi</button>
